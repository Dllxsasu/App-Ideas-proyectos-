...
public class main extends javax.swing.JFrame {
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(txtBinary, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(131, 131, 131)
    ...
    private void convert2Decimal() {
        String biry = txtBinary.getText();
        int deci = 0;
        String sign = "";
        for (int i = 0, digit = 1; i < biry.length(); i++, digit++) {

            if (Character.getNumericValue(biry.charAt(i)) == 1 || Character.getNumericValue(biry.charAt(i)) == 0) {
                deci += Character.getNumericValue(biry.charAt(i)) * digit;
            } else if (Character.getNumericValue(biry.charAt(i)) > 1) {
                JOptionPane.showMessageDialog(this, "Please, enter a binary number");
                return;
            }
            if (biry.charAt(i) == '-') {
                sign = "-";
        ...
        txtDecimal.setText(sign + String.valueOf(deci));
